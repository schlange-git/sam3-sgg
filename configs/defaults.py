...
def add_dataset_config(cfg):
  ...
  _C.DATASETS.ACTION_GENOME.SAMPLER_MODE = "clip"
  _C.DATASETS.ACTION_GENOME.CLIP_SAMPLE_LEN = 4
...
# Quality-aware auxiliary CE masking (default OFF)
  ...
  # ---- Temporal Triplet Memory (temporal_v3) ----
  ...
  # gate + warmup (ratio-based)
  _C.MODEL.TEMPORAL.GATE_MAX_OBJECT = 0.15
  _C.MODEL.TEMPORAL.GATE_MAX_RELATION = 0.30
  _C.MODEL.TEMPORAL.LEARNABLE_GATE = False
  _C.MODEL.TEMPORAL.LEARNABLE_GATE_INIT_OBJECT = 0.15
  _C.MODEL.TEMPORAL.LEARNABLE_GATE_INIT_RELATION = 0.30
  _C.MODEL.TEMPORAL.GATE_ZERO_END_RATIO = 0.10
  _C.MODEL.TEMPORAL.GATE_WARMUP_END_RATIO = 0.30
  # memory update curriculum
  ...
  # memory update (prediction mode)
  _C.MODEL.TEMPORAL.UPDATE_SCORE_THRESH = 0.10
  ...
  _C.MODEL.TEMPORAL.MAX_DELTA_T_BUCKET = 7
  # debug
