#!/usr/bin/env bash
# Single-GPU overfit test for X-SAM patch-merge downsampling only.
# Temporal and ROI refine are disabled. Train and test both use AG_train.
...
echo "=============================================="
echo "[Overfit X-SAM No ROI] OUTPUT=${OUTPUT_DIR}"
echo "[Overfit X-SAM No ROI] single GPU, BS=12, MAX_ITER=16000"
echo "[Overfit X-SAM No ROI] train/test = dataset_overfit_temporal as AG_train"
echo "=============================================="
