#!/usr/bin/env bash
# Overfitting temporal training (1000 frames, 16000 iters)
# Scaled: WARMUP=500, STEPS=(4000,12000), EVAL_PERIOD=500
set -euo pipefail
...
# Overfitting-specific: custom annotations, frames from original dataset
AG_ANNOTATIONS="dataset_overfit/annotations"
...
echo "=============================================="
echo "[Overfit] OUTPUT=${OUTPUT_DIR}"
echo "[Overfit] GPU=${NUM_GPUS}"
echo "[Overfit] ANNOTATIONS=${AG_ANNOTATIONS}"
echo "[Overfit] MAX_ITER=16000 WARMUP=500 STEPS=(4000,12000)"
echo "=============================================="
