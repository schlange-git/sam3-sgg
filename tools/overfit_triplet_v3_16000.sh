#!/usr/bin/env bash
# Overfit triplet memory v3: eval-first + 16000 iters + eval every 2000
set -euo pipefail
PROJ=/home/cfs/shizekun1_v/sam3-sgg-Auxiliary-Matching
cd "$PROJ"
OUTPUT_DIR="${1:-z_outputs/overfit_triplet_v3_16000}"
mkdir -p "${OUTPUT_DIR}"
export ROI_GATE_LOG_PATH="${OUTPUT_DIR}/roi_gate_log.csv"
echo "[Triplet v3 16K] OUTPUT=${OUTPUT_DIR}"
...
RET=$?
echo "[Triplet v3 16K] Done exit=${RET}"
