...
OUT_DIR="${PROJ}/z_outputs/temporal_finetune_79999_bs16_20k_update001_gatefree_2gpu"
...
assert_file "${PROJ}/SpeaQ/engine/trainer.py"

grep -q "SOLVER.TEMPORAL_LR_MULTIPLIER" "${PROJ}/configs/defaults.py"
grep -q "TEMPORAL_LR_MULTIPLIER" "${PROJ}/SpeaQ/engine/trainer.py"
