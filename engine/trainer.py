        ...
        if roi_gate_before is not None:
            try:
                ...
                with open(gate_log_path, "a") as f:
                    ...
                    cls_keys = sorted([k for k in obj_stats if k.endswith("_mean") or k.startswith("gate_")])
                    if cls_keys:
                    ...
                    per_cls_keys = sorted([k for k in obj_stats if k.endswith("_mean") or k.startswith("gate_")])
